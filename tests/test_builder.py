...
class TestBuilder(unittest.TestCase):
    ...
    def test_plain_byte_text(self):
        msg = builder.build_msg(u'Test <test@test.com>', u'The Subject', send_to=u'Example <example@example.com>', plain_text=b'Some Text')
        self.assertIsNotNone(msg)

    def test_html_byte_text(self):
        msg = builder.build_msg(u'Test <test@test.com>', u'The Subject', send_to=u'Example <example@example.com>', html_text=b'<b>Some Bold Text</b>')
        self.assertIsNotNone(msg)
