...
def send_email(host, port, send_from, subject, send_to=None, send_cc=None, send_bcc=None, plain_text=None, html_text=None, attachment_list=None, inline_attachment_dict=None, username=None, password=None, timeout=None, require_starttls=False):
    ...
    send_msg(msg, host, port, username=username,
             password=password, timeout=timeout, require_starttls=require_starttls)
