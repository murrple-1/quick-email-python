...
def send_email(host, port, send_from, subject, send_to=None, send_cc=None, send_bcc=None, plain_text=None, html_text=None, attachment_list=None, inline_attachment_dict=None, username=None, password=None, is_tls=False):
    ...
    send_msg(msg, host, port, username=username, password=password, is_tls=is_tls)
